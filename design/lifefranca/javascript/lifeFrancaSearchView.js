;(function ($, window, document, undefined) {
    ...
    function LifeFrancaSearchView(element, options) {
        this.query = '';
    ...
    LifeFrancaSearchView.prototype = {

        log: function (text) {
            if (window.console && this.options.debug == true) {
                window.console.log('LifeFrancaSearchView: ' + text);
            }
        },
    ...
    $.fn['lifeFrancaSearchView'] = function (options) {
        return this.each(function () {
            if (!$.data(this, 'lifeFrancaSearchView')) {
                $.data(this, 'lifeFrancaSearchView', new LifeFrancaSearchView(this, options));
            }
        });
    };
